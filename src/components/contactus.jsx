    ...
    <>
        ...
        <Grid container>
                                ...
                                <Container>
                                    <Grid container>
                                        ...
                                        <Grid item lg={12} md={12} sm={12}>
                                            ...
                                            />
                                            <p style={{ color: '#8f0707', fontWeight: 'bold', fontSize: 12, textAlign: 'center' }}>{props.touched.message && props.errors.message}</p>
                                        </Grid>
            ...
            <Grid className={classes.about} item lg={5} sm={12} md={5} xs={12}>
                ...
                <p style={{ textAlign: 'left', marginTop: '3%', marginLeft: '5%', fontFamily: 'unset' }}>
                    A creator-friendly customer support team that's always
                    just a click away
                    Our average response time is under 10 to 15 minutes”
                </p>
            </Grid>
        </Grid>
        <Footer />
