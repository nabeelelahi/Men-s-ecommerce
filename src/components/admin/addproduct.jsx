...
function Addproduct() {
    ...
    function checkAdmin() {
        ...
        const admin = adminString?.length ? JSON.parse(adminString) : null
                    ...
                    <Grid className={classes.div} spacing={3} container>
                        <Grid className={classes.signup} item lg={12} sm={12} md={12}>
                            <Formik
                                ...
                                initialValues={{ Name: '', Price: '', Discription: '', sizes: "", Categorie: '', }}
                                onSubmit={(values, actions) => {
                                    ...
                                    if (productPhoto) {
                                        ...
                                        form.append("sizes", values?.sizes)
                                    ...
                                    try {
                                        fetch(
                                            ...
                                            {
                                                method: "POST",
                                                body: productPhoto ? form : JSON.stringify(values),
                                            }
                                        ).then(async (response) => {
                                        ...
                                        <>
                                            <Container>
                                                <Grid container>
                                                    ...
                                                    <Grid item lg={6} md={6} sm={12}>
                                                        <p style={{ color: '#1c1c15', marginLeft: '5%' }}>Sizes:</p>
                                                        <FormControl className={classes.formControl}>
