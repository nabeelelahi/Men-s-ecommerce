                                            ...
                                            fetch(
                                                ...
                                                .then(async (response) => {
                                                    ...
                                                    if (resJSON.info && resJSON.info._id !== '60e8318138b565168427cdfb') {
                                                        ...
                                                        resJSON.info.type = 'admin'
                                                        sessionStorage.setItem("admin", JSON.stringify(resJSON.info));
                                                        navigate('/admin')
                                                    }
                                                    else {
                                        ...
                                        return (
                                            <>
                                                ...
                                                <Grid container>
                                                    ...
                                                    <Grid item lg={8} sm={4} md={6} xs={4} />
                                                    <Grid item lg={4} sm={8} md={6} xs={12} xs={8}>
                                                        <div
                                                            style={{
                                                                backgroundColor: 'hsla(60, 14%, 10%, 0.85)',
                                                                textAlign: 'center',
                                                                fontSize: '10px',
                                                                padding: "3%",
                                                                width: "100px",
                                                        ...
                                                        >
                                                            <Link style={{ marginLeft: '5px', color: '#fff', textDecoration: 'none' }} to='/forgot-password'>
                                                                Forgot Password ?
                                                            </Link>
                                                        </div>
                                                    </Grid>
